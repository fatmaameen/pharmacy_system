                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a class="btn btn-primary" role="button"  href="{{ route('nigth_subcategories.create') }}">اضافة قسم فرعي جديد </a>
                                    </div>
                                    @if (session('message'))
                            ...
                            <div class="card-body">
                                ...
                                <td>
                                    <a class="btn btn-secondary" role="button" href="{{ route('nigth_show_subsub' , $sub->id) }}">  عرض الاقسام الفرعية </a>
                                </td>
