                ...
                <div class="col-md-9 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <h4 class="card-title mb-0">تعديل القسم الفرعي ل
                            ...
                            @endif
                                ...
                                @endif
                                    ...
                                    <form action="{{ route('nigth_subcatg.update' ,$subcatg->id)}}" method="POST"
                                        ...
                                        @method('put')
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="أدخل اسم القسم " value="{{$subcatg->name}}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="compnayNameinput" class="form-label">الاقسام الرئيسية</label>
                                                    <select class="form-select mb-3" required name="category_id"
                                                        aria-label="Default select example">
                                                        <option selected value="">اختر القسم الرئيسي لهذا القسم الفرعي</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="leader"
                                                        placeholder="أدخل اسم المدير السئول " value="{{$subcatg->leader}}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="phone_subcatg"
                                                        ...
                                                        value="{{$subcatg->phone_subcatg}}" required><br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="number_employee"
                                                        placeholder="أدخل  عدد الموظفين العاملين  بالقسم " value="{{ $subcatg->number_employee }}"
                                                        required id="firstNameinput"><br>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control" name="email"
                                                        placeholder="  القسم Email  " value="{{$subcatg->email }}"
                                                        required id="firstNameinput"><br>
