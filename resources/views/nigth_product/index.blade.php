                                ...
                                <table id="alternative-pagination"
                                   ...
                                   @foreach ( $data as $dataa )
                                        ...
                                        <td>{{ $loop->iteration }}</td>
                                          ...
                                          <td>
                                            <a class="btn btn-secondary" role="button" href="{{ route('nigth_show_addquantity' , $dataa->id) }}">الكميات المضافة</a>
                                           </td>
                                        <td>
                                         <a class="btn btn-primary" role="button" href="{{ route('raw.nigth.edit' , $dataa->id) }}">تعديل المنتج</a>

                                        <a class="btn btn-danger" role="button" href="{{ route('nigth_product.addQuantity' , $dataa->id) }}">اضافة كمية</a>
                                     </td>
