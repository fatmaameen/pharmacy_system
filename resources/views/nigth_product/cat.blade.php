                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <h3>قائمة الاقسام الرئيسية الموجودة في الشيفت المسائي</h3>
                                ...
                                <table id="alternative-pagination"
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$catg->name}}</td>
                                            <td>
                                                <a href="{{ route('nigth.subcategories.index', $catg->id) }}" class="btn btn-primary"><i class='bx bxs-category'></i></a>

                                            </td>
                                            <td>
                                                <a href="{{ route('nigth_show_product' , $catg->id) }}" class="btn btn-primary">عرض</a>
                                            </td>
