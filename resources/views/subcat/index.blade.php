                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <h1 class="card-title mb-0 col-sm-8 col-md-10">قائمة الاقسام الفرعية</h1><br>
                                    <div class="d-flex justify-content-between">
                                        <a class="btn btn-primary" role="button"  href="{{ route('subcategories.create') }}">اضافة قسم فرعي جديد </a>
                                    </div>
                                    @if (session('message'))
                            ...
                            <div class="card-body">
                                ...
                                <td>
                                    <a class="btn btn-secondary" role="button" href="{{ route('show_subsub' , $sub->id) }}">  عرض الاقسام الفرعية </a>
                                </td>
