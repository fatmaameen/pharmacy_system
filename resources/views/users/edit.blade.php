                ...
                <div class="col-md-9 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <h4 class="card-title mb-0">تحديث الحساب</h4>
                            <div class="card-body ">
                                <div class="listjs-table" id="customerList">
                                    ...
                                    <form action="{{ route('super.admin.create.admin.company.update',$data->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="أدخل الاسم" value="{{ $data->name }}" required
                                                        id="firstNameinput">
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control" name="email"
                                                        placeholder="أدخل البريد الإلكتروني" value="{{$data->email }}" required
                                                        id="firstNameinput">
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    >
                                                        <optgroup label="role select">
                                                            <option value="">
                                                                حدد الدور
                                                            </option>
                                                            @foreach($roles as $item)
                                                            <option value="{{ $item->id }}" {{$item->id==$data->role_id ? 'selected':''}}>
                                                              {{ $item->name }}
                                                            </option>
                                                            @endforeach
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    >
                                                        <optgroup label="job title select">
                                                            <option value="">
                                                               select job title
                                                            </option>
                                                            @foreach($job_title as $item)
                                                            <option value="{{ $item->id }}" {{$item->id==$data->job_type ? 'selected':''}}>
                                                              {{ $item->title }}
                                                            </option>
                                                            @endforeach
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" value="1" type="radio"
                                                            name="status" id="yes1"  {{$data->status==1? 'checked':''}}>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" value="0" type="radio"
                                                            name="status" id="no" {{$data->status==0? 'checked':''}}>
