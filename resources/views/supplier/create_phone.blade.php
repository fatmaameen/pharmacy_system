                ...
                <div class="col-md-9 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <h4 class="card-title mb-0">إنشاء هاتف
                            </h4>
                            <div class="card-body ">
                                ...
                                @endif
                                    ...
                                    <form action="{{ route('admin.companies.suppliers.store_phone',$id) }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label for="firstNameinput" class="form-label">اسم الهاتف</label>
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="أدخل اسم الهاتف " value="{{ old('name') }}"
                                                         id="firstNameinput">
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-lg-12 my-2">
                                                <div class="text-center">
                                                    ...
                                                    <a  href="{{route('admin.companies.suppliers.create_address',$id)}}" class="btn btn-warning">التالى</a>
