                ...
                <div class="col-md-9 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <h4 class="card-title mb-0">تعديل بيانات هذا المورد
                            </h4>
                            <div class="card-body ">
                                ...
                                @endif
                                    ...
                                    <form action="{{ route('admin.companies.suppliers.store.update',$data1->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="firstNameinput" class="form-label">اسم المورد</label>
                                                    <input type="text" class="form-control" name="name"
                                                        placeholder="أدخل اسم المورد" value="{{$data1->name}}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="location"
                                                        placeholder="أدخل موقع الشركة الموردة (عنوان URL لخريطة جوجل)" 
                                                         id="firstNameinput">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="tel" required class="form-control" name="phone" value="{{ $data3->phone }}" placeholder="+(20) 10346632" id="phonenumberInput">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1" class="form-label"> Email </label>
                                                    <input type="email" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data1->email  }}" placeholder=".....@gmail.com">
                                                </div>
                                                  </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
