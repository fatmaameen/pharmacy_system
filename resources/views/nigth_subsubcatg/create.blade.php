                ...
                <div class="col-md-9 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <h4 class="card-title mb-0">  انشاء قسم فرعي جديد للاقسام الفرعية الموجودة
                            ...
                            <div class="card-body ">
                                ...
                                @endif
                                    ...
                                    <form action="{{ route('nigth_subsubcategories.store')}}" method="POST"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="name"
                                                        ...
                                                        required id="firstNameinput">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                <label for="inputName" class="control-label">الاقسام الفرعية</label>
                                                                <select name="subcategory_id" class="form-control SlectBox">

                                                                   <option value="" selected disabled>اختر القسم الفرعي </option>
                                                                    @foreach ($subcatg as $catg)
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="phone_subsubcatg"
                                                            ...
                                                            value="{{ old('phone_subsubcatg') }}"  required id="firstNameinput"><br>
                                                    </div>
                                                </div>
