...
<div class="btn-group mt-3">
    <button class="btn btn-primary">
        <a href="{{ route('categories.index') }}" style="color: inherit; text-decoration: none; display: block;">  قائمة الاقسام الرئيسية</a>
    </button>
    <button class="btn btn-primary">
        <a href="{{ route('subcategories.index') }}" style="color: inherit; text-decoration: none; display: block;">قائمة الاقسام الفرعية</a>
    </button>
    <button class="btn btn-primary">
        <a href="{{ route('subsubcategories.index') }}" style="color: inherit; text-decoration: none; display: block;">  الاقسام الفرعية لقائمة الاقسام الفرعية </a>
    </button>
</div>
