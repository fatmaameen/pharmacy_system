                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <h6 class="card-title mb-0 col-sm-8 col-md-12">قائمة الاقسام الرئيسية للشيفت المسائي</h6><br>
                                    <div class="d-flex justify-content-between">
                                        <a class="btn btn-primary" role="button"  href="{{ route('nigth_categories.create') }}">اضافة قسم جديد</a>
                                    </div>
                                    @if (session('message'))
                                ...
                                <table id="alternative-pagination"
                                    ...
                                    <tbody>
                                       ...
                                       <td>
                                        ...
                                        <a class="btn btn-secondary" role="button" href="{{ route('nigth_show_sub' , $category->id) }}">  عرض الاقسام الفرعية </a>
                                        <a class="btn btn-primary" role="button" href="{{ route('nigth_categories.edit' , $category->id ) }}">تعديل بيانات القسم</a>
                                       </td>
