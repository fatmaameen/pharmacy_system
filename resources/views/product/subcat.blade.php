                                ...
                                <table id="alternative-pagination"
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$sub->name}}</td>
                                            <td>
                                                <a href="{{ route('raw.matiries.subsubcategories.material.index' ,$sub->id) }}" class="btn btn-primary"><i class='bx bxs-category'></i></a>
                                            </td>
                                            <td>
                                                <a class="btn btn-primary" role="button" href="{{ route('show_subproducts' , $sub->id) }}">  عرض   </a>
                                            </td>
