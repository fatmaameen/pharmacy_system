                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <h5 class="card-title mb-0 col-sm-8 col-md-10"> </h5>

                                    <h3>قائمة الاقسام الرئيسية الموجودة في الشيفت الصباحي</h3>
                                    <!-- Load More Buttons -->
                                ...
                                <table id="alternative-pagination"
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$catg->name}}</td>
                                            <td>
                                                <a href="{{ route('raw.matiries.subcategories.material.index' , $catg->id) }}" class="btn btn-primary"><i class='bx bxs-category'></i></a>

                                            </td>
                                            <td>
                                                <a href="{{ route('show_product' , $catg->id) }}" class="btn btn-primary">عرض</a>
                                            </td>
